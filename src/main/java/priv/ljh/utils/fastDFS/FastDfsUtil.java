...
//LoggerFactory.getLogger(FastDfsUtil.class);
// static {
// try {
// String filePath = new
//ClassPathResource("fdfs_client.conf").getFile().getAbsolutePath();
// ClientGlobal.init(filePath); } catch (Exception e) {
...
// String remoteFileName) throws
//IOException { TrackerClient trackerClient = new TrackerClient();
// TrackerServer trackerServer = trackerClient.getConnection();
